...
from src.utils import (get_attn_key_pad_mask, get_attn_pad_mask, get_non_pad_mask, get_subsequent_mask, pad_list)
...
class Decoder(nn.Module):
    ...
    def preprocess(self, padded_input):
        ...
        """
        ys = [y[y != Const.IGNORE_ID] for y in padded_input]  # parse padded ys
        ...
        ys_out_pad = pad_list(ys_out, Const.IGNORE_ID)
    ...
    def recognize_beam(self, encoder_outputs, char_list, args):
        ...
        #         line = line.strip('\n')
        #         for char in line:
        #             vector = han2id(char, char_list)
        #             word_id.append(vector)
        ...
        for i in range(maxlen):
            ...
            for hyp in hyps:
                # print('hypo: ' + ''.join([char_list[int(x)] for x in hyp['yseq'][0, 1:]]))
                pass
